...
from planner.evaluation.rl_temporal_v4_operational_holdout import (  # noqa: E402
    MODO_EXTENSION,
    MODO_FULL,
    MODO_GREEDY,
    MODO_OPERACIONAL,
...
from planner.rl.rl_temporal_v4_operational import (  # noqa: E402
    RLTemporalV4OperationalPlanner,
    cargar_configuracion_operacional,
)
from planner.rl.rl_temporal_v4_planner import RLTemporalV4Planner  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=(
            ...
            / "pedemonte_temporal_v4_operational.json"
        ),
    )
    ...
    parser.add_argument(
        ...
        default=(
            ...
            / "16D_11_operational_holdout_278000"
        ),
    )
