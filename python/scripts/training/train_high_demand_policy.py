...
from planner.rl.high_demand_policy_curriculum import (  # noqa: E402
...
from planner.rl.high_demand_policy_validation import (  # noqa: E402
...
from planner.rl.high_demand_policy_generator import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--base-config",
        type=Path,
        default=base_dir / "balanced_policy_config.json",
    )
    parser.add_argument(
        "--base-selection",
        type=Path,
    ...
    parser.add_argument(
        ...
        default=(
            ...
            / "balanced_policy_holdout.json"
        ),
    )
    parser.add_argument(
        "--run-name",
        default="policy_high_demand",
    )
...
def main() -> None:
    ...
    guardar_json(
        run_dir / "high_demand_policy_config.json",
        {
