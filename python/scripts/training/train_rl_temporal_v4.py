...
from planner.rl.rl_temporal_v4_curriculum import (  # noqa: E402
...
from planner.rl.rl_temporal_v4_validation import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--run-name",
        default="phase16d_temporal_v4_quick",
...
def promover_modelo(
    ...
    destino = (
        ...
        / "models"
        / "rl"
        / "pedemonte_maskable_ppo_temporal_v4.zip"
    )
...
def main() -> None:
    ...
    guardar_json(
        run_dir / "temporal_v4_config.json",
        {
            ...
            callbacks = CallbackList(
                [
                    CheckpointCallback(
                        ...
                        name_prefix="maskable_ppo_temporal_v4",
                        verbose=1,
                    ),
