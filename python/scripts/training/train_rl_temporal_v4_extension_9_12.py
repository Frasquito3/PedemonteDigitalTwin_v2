...
from planner.rl.rl_temporal_v4_extension_curriculum import (  # noqa: E402
    EtapaExtensionTemporalV4RL,
    crear_curriculum_extension_temporal_v4_diagnostico,
)
from planner.rl.rl_temporal_v4_extension_validation import (  # noqa: E402
...
from planner.rl.temporal_v4_extension_generator import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    base_dir = (
        PYTHON_ROOT / "rl_artifacts" / "phase16d_temporal_v4_quick"
    )
    ...
    parser.add_argument(
        "--base-config",
        type=Path,
        default=base_dir / "temporal_v4_config.json",
    )
    parser.add_argument(
        "--base-selection",
        type=Path,
    ...
    parser.add_argument(
        "--run-name",
        default="phase16d_temporal_v4_extension_9_12",
    )
...
def main() -> None:
    ...
    guardar_json(
        run_dir / "temporal_v4_extension_config.json",
        {
            "version_run": (
            ...
            callbacks = CallbackList(
                [
                    CheckpointCallback(
                        ...
                        name_prefix="maskable_ppo_temporal_v4_ext_9_12",
                        verbose=1,
                    ),
