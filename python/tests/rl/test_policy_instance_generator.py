...
from planner.rl.policy_instance_generator import ConfiguracionGeneradorTemporalV4, GeneradorInstanciasTemporalV4RL
...
class TemporalV4InstanceGeneratorTest(unittest.TestCase):
    ...
    def test_genera_patron_v4_temprano_medio_tardio(self) -> None:
        ...
        generador = GeneradorInstanciasTemporalV4RL(base, ConfiguracionGeneradorTemporalV4(probabilidad_patron_ventanas_conflictivas=1.0))
        instancia = generador.generar(164101)
        marcados = [pedido for pedido in instancia.pedidos if GeneradorInstanciasTemporalV4RL.MARCA_PATRON in pedido.observaciones]
