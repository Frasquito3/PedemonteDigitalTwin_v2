...
def escribir_resultados(
    ...
    *,
    ...
    rutas = {
        "evaluacion_json": destino / "rl_temporal_v4_extension_holdout.json",
        "corridas_csv": destino / "rl_temporal_v4_extension_holdout_runs.csv",
        "resumen_csv": destino / "rl_temporal_v4_extension_holdout_summary.csv",
        "estratos_csv": destino / "rl_temporal_v4_extension_holdout_strata.csv",
        "segmentos_csv": destino / "rl_temporal_v4_extension_holdout_segments.csv",
        "casos_csv": destino / "rl_temporal_v4_extension_holdout_cases.csv",
        "semillas_csv": destino / "rl_temporal_v4_extension_holdout_seeds.csv",
    }
