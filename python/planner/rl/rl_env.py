...
class PedemontePlanEnv(
    ...
    def __init__(
        ...
        self.configuracion_reward = (
            configuracion_reward
            if configuracion_reward is not None
            else ConfiguracionRewardRL(
                modo=ModoRewardRL.ABSOLUTO,
                escala_absoluta=escala_reward,
            )
        )
        ...
        self.costo_greedy_referencia: float | None = None

        if (
            self.configuracion_reward.modo
            ==
            ModoRewardRL
            .VENTAJA_GREEDY_RELATIVA
        ):
            plan_greedy_referencia = (
                generar_plan_greedy(
                    instancia,
                    configuracion=(
                        self.configuracion
            ...
            self.costo_greedy_referencia = float(
                plan_greedy_referencia
                .costo_estimado
            )
